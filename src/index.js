...
//       const dataReturned =
//         document.querySelector(".dogs-list__button").dog.name;
...
//     main.className = "main";
//     main.innerHTML = `<article class="main__dog-section"> <h2></h2><img/> <div class= "main__dog-section__desc"> <h3></h3> <p></p></div></article>`;
